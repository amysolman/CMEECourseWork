...
TotalData <- TotalData[TotalData$area <= max(TotalData$area)/8, ]
...
pdf("../../Results/Simulation/SolmanChisholmBoxplotLow.pdf")
...
write.csv(MyStats, "../../Results/Simulation/MyStatsLow.csv")
...
pdf("../../Results/Simulation/SolmanSpeciesHistogramLow.pdf")
h1 <- hist(SolmanData$island_species) #produces left skewed data
print(h1)
dev.off()

######HISTOGRAM OF ISLAND AREAS
pdf("../../Results/Simulation/SolmanAreaHistogramLow.pdf")
h2 <- hist(SolmanData$area)
print(h2)
dev.off()

#####HISTOGRAM OF CHISHOLM SPECIES RICHNESS
pdf("../../Results/Simulation/ChisholmDataHistogramLow.pdf")
...
pdf("../../Results/Simulation/CollinearityPlotLow.pdf")
...
write.csv(df, "../../Results/Simulation/CollineaityResultsLow.csv")
...
write.csv(VIF_Results, "../../Results/Simulation/NichesAreaVIFResultsLow.csv")
...
#Save to CSV 
write.csv(df, "../../Results/Simulation/tTestResultsLow.csv")
...
#Save to CSV 
write.csv(df, "../../Results/Simulation/PairedtTestResultsLow.csv")
...
write.csv(df4, "../../Results/Simulation/lmResultsLow.csv")
...
pdf("../../Results/Simulation/AreaSpeciesResidualHistoLow.pdf")
h4 <- hist(model1$residuals)
print(h4)
dev.off()

pdf("../../Results/Simulation/NicheSpeciesResidualHistoLow.pdf")
...
pdf("../../Results/Simulation/AreaSpeciesLmPlotLow.pdf")
par(mfrow=c(2,2))
m2 <- plot(model2)
print(m2)
dev.off()

pdf("../../Results/Simulation/NicheSpeciesLmPlotLow.pdf")
par(mfrow=c(2,2))
m3 <- plot(model3)
print(m3)
dev.off()
...
pdf("../../Results/Simulation/HistoForMultivariateAnalysisLow.pdf")
plot(h6)
plot(h7)
plot(h8)
dev.off()
...
pdf("../../Results/Simulation/NicheAreaMigrationLmPlotLow.pdf")
par(mfrow=c(2,2))
m4 <- plot(model4)
print(m4)
dev.off()

pdf("../../Results/Simulation/NicheAreaLmPlotLow.pdf")
par(mfrow=c(2,2))
m5 <- plot(model5)
print(m5)
dev.off()

pdf("../../Results/Simulation/NicheLmPlotLow.pdf")
par(mfrow=c(2,2))
m6 <- plot(model6)
print(m6)
dev.off()
...
write.csv(repeatability, "../../Results/Simulation/repeatabilityscoreLow.csv")
