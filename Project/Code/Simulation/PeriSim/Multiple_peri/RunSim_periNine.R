...
output_file_name = paste0("simulation_peri_nine_", i, ".rda")

cluster_run_function(nu = 0.00009, m0 = 0.8, num_islands = 20, k = 45, wall_time = 1440, output_file_name = output_file_name)
