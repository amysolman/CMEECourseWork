...
output_file_name = paste0("simulation_peri_one_", i, ".rda")

cluster_run_function(nu = 0.00001, m0 = 0.09, num_islands = 20, k = 5, wall_time = 1440, output_file_name = output_file_name)
