...
for (j in 1:10){
  ...
  file_name = paste0("../../../Results/Simulation/NLLSPlotPeri", j, ".pdf")
  pdf(file_name)
  print(p1)
  dev.off()
...
#export as csv
write.csv(my_df, "../../../FinalReport/PeriParam.csv", row.names = FALSE, quote = FALSE)
...
pdf("../../../FinalReport/PeriThetaResults.pdf")
print(p1)
dev.off()

pdf("../../../FinalReport/Perim0Results.pdf")
print(p2)
dev.off()

pdf("../../../FinalReport/PeriKResults.pdf")
print(p3)
dev.off()

#############is the difference between the paired values normally distributed?

shapiro.test(theta_results$Difference) 

shapiro.test(m0_results$Difference) 

shapiro.test(K_results$Difference) 
