...
ImportMyData <- function(num_sim) {
  my_sims <- list()
  for (i in 1:100) {
    try(load(paste0(file="../../../Data/SimData/Classic/simulation_classic_", num_sim, "_", i, ".rda")), silent=T)
...
file_name = paste0("../../../Results/Simulation/ClassicTimeseriesPlot_", j, ".pdf")
pdf(file_name)
