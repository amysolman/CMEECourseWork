...
output_file_name = paste0("simulation_classic_seven_", i, ".rda")

cluster_run_function(nu = 0.00007, m0 = 0.07, num_islands = 20, k = 35, wall_time = 1440, output_file_name = output_file_name)
