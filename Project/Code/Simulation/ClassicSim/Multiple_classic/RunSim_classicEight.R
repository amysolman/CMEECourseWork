...
output_file_name = paste0("simulation_classic_eight_", i, ".rda")

cluster_run_function(nu = 0.00008, m0 = 0.08, num_islands = 20, k = 40, wall_time = 1440, output_file_name = output_file_name)
