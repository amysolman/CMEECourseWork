...
output_file_name = paste0("simulation_classic_four_", i, ".rda")

cluster_run_function(nu = 0.00004, m0 = 0.04, num_islands = 20, k = 20, wall_time = 1440, output_file_name = output_file_name)
