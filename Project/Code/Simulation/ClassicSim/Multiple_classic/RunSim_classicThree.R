...
output_file_name = paste0("simulation_classic_three_", i, ".rda")

cluster_run_function(nu = 0.00003, m0 = 0.03, num_islands = 20, k = 15, wall_time = 1440, output_file_name = output_file_name)
