...
output_file_name = paste0("simulation_classic_ten_", i, ".rda")

cluster_run_function(nu = 0.0001, m0 = 0.1, num_islands = 20, k = 50, wall_time = 1440, output_file_name = output_file_name)
