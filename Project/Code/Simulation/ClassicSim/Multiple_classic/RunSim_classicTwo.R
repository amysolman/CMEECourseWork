...
output_file_name = paste0("simulation_classic_two_", i, ".rda")

cluster_run_function(nu = 0.00002, m0 = 0.02, num_islands = 20, k = 10, wall_time = 1440, output_file_name = output_file_name)
