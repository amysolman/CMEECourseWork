...
output_file_name = paste0("simulation_classic_six_", i, ".rda")

cluster_run_function(nu = 0.00006, m0 = 0.06, num_islands = 20, k = 30, wall_time = 1440, output_file_name = output_file_name)
