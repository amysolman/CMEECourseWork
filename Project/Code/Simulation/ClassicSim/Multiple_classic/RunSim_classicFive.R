...
output_file_name = paste0("simulation_classic_five_", i, ".rda")

cluster_run_function(nu = 0.00005, m0 = 0.05, num_islands = 20, k = 25, wall_time = 1440, output_file_name = output_file_name)
