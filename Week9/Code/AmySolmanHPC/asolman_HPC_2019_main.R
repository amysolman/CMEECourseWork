...
question_8 <- function() {
  ...
  return("Over a long enough timescale, the system will always converge to a state of homogeneity. This is because as a species gains proportional dominance, it has an increased likelihood of contributing to the next generation above other competing species.")
}
...
question_12 <- function(community_1, community_2, speciation_rate, duration)  {
  ...
  return("Over a long enough timescale, regardless of initial high or low diversity, the two communities converged at a state of dynamic equilibrium. This is because, after a burnout period of generations, speciation and extinction rate balance within the communities.")
}
...
question_16 <- function()  {
  ...
  return("The initial condition of the system fails to have a significant effect on the final species abundance distribution. Regardless of the initial species richness of a community, over a long enough time period the community reaches equilibrium.")
}
