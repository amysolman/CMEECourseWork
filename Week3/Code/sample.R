...
lappy_sample <- function(popn, n, num){
       result4 <- lappy(1:num, function(i) myexperiment(popn, n))
       return(result4)
}

## To run"num" iterations of ther experiment using vectorization with lappy
...
print("The loopy, non-preallocation")